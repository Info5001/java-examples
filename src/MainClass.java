...
public class MainClass {
    public static void main(String[] args) {
         ...
         * 2. index < 50; This loop will run when this condition is true. Once this
        ...
        for (int index = 50; index > 0; index--) {
            System.out.println("Iteration number: " + (50 - index) + " index equals " + index);
        }
        ...
        Address nuAddress = new Address(360, "Huntington Ave", "02115", "42.3400375,-71.0888419");
