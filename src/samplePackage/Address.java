...
public class Address { // Contents of the class and out inside curly braces, they start here.
    ...
    public Address(int streetNum, String streetName, String zip, String gps) {
